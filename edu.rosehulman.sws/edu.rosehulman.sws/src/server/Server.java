/*
 * Server.java Oct 7, 2012 Simple Web Server (SWS) for CSSE 477 Copyright (C) 2012 Chandan Raj Rupakheti This program is free software: you can
...
/**
 * This represents a welcoming server for the incoming TCP request from a HTTP client such as a web browser.
 *
...
public class Server implements Runnable
{
	...
	/**
	 * Returns connections serviced per second. Synchronized to be used in threaded environment.
	 *
	 * @return
	 */
	...
	/**
	 * Increments number of connection by the supplied value. Synchronized to be used in threaded environment.
	 *
	 * @param value
	 */
	...
	/**
	 * Increments the service time by the supplied value. Synchronized to be used in threaded environment.
	 *
	 * @param value
	 */
	...
	/**
	 * The entry method for the main server thread that accepts incoming TCP connection request and creates a {@link ConnectionHandler} for the
	 * request.
	 */
	@Override
	public void run()
