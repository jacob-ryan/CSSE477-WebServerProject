/*
 * PutRequest.java Oct 18, 2015 Simple Web Server (SWS) for EE407/507 and CS455/555 Copyright (C) 2011 Chandan Raj Rupakheti, Clarkson University This
...
public class PutRequest extends HttpRequest
{
	 ...
	 * @param version
	 */
	public PutRequest(String uri, String version)
	{
		super(uri, version);
	}
