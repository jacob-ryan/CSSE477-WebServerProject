...
public abstract class HttpRequest 
{
	...
	public abstract HttpResponse handleRequest(String rootDirectory);
	...
	public HttpRequest(String uri, String version)
	{
		this.uri = uri;
	...
	public static HttpRequest read(InputStream inputStream) throws Exception 
	{
		...
		{
			request = new GetRequest(uri, version);
		}
		else if(method.equals("PUT"))
		{
			request = new PutRequest(uri, version);
		}
		else if(method.equals("POST"))
		{
			request = new PostRequest(uri, version);
		}
		else if(method.equals("DELETE"))
		{
			request = new DeleteRequest(uri, version);
		}
		else
		{
