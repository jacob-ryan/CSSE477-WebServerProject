/*
 * Protocol.java Oct 7, 2012 Simple Web Server (SWS) for CSSE 477 Copyright (C) 2012 Chandan Raj Rupakheti This program is free software: you can
...
/**
 * This class is a collection of HTTP protocol related constants, that can be used uniformly across the classes of this project.
 *
...
public class Protocol
{
	...
	public static final String CRLF = "" + Protocol.CR + Protocol.LF;
	...
	public static final String DELETED_TEXT = "NO CONTENT";
	...
	/**
	 * A chunk size to be used when reading a file and sending it to a socket. Rather than reading the whole file at once, we divide the reading of
	 * the file into number of small chunk of bytes and send each chunk to the socket to utilize the memory better.
	 */
	...
	public static String getServerInfo()
	{
		...
		String serverInfo = Protocol.SERVER_INFO + Protocol.SPACE + "(" + os + Protocol.SLASH + osVersion + Protocol.SLASH + architecture + ")";
		return serverInfo;
	}
}
