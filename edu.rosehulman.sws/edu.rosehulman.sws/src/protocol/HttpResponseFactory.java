/*
 * HttpResponseFactory.java Oct 7, 2012 Simple Web Server (SWS) for CSSE 477 Copyright (C) 2012 Chandan Raj Rupakheti This program is free software:
...
public class HttpResponseFactory
{
	...
	/**
	 * Creates a {@link HttpResponse} object for sending the supplied file with supplied connection parameter.
	 *
	 * @param file The {@link File} to be sent.
	 * @param connection Supported values are {@link Protocol#OPEN} and {@link Protocol#CLOSE}.
	 * @return A {@link HttpResponse} object represent 200 status.
	 */
	public static HttpResponse createSuccess(File file, String connection, int statusCode)
	{
		HttpResponse response = new HttpResponse(Protocol.VERSION, statusCode, Protocol.OK_TEXT, new HashMap<String, String>(), file);
	...
	{
		HttpResponse response = new HttpResponse(Protocol.VERSION, Protocol.NOT_FOUND_CODE, Protocol.NOT_FOUND_TEXT, new HashMap<String, String>(),
				null);
